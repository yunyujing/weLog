...
public class CheckPlanActivity extends AppCompatActivity {
    ...
    public static void startCheckPlanActivity(Context context, BaseBean baseBean) {
     ...
     * @param commment
     */
    private void addDataToSql(int id, int stateId, String commment) {
