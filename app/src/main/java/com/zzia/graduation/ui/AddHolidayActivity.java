...
public class AddHolidayActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        actionBar = (MyActionBar) findViewById(R.id.add_holiday_layout_actionbar);
        ...
        checker = (Spinner) findViewById(R.id.add_holiday_layout_spinner);
        ...
        startDate = (TextView) findViewById(R.id.add_holiday_layout_start_date);
        startDate.setOnClickListener(this);
        startTime = (TextView) findViewById(R.id.add_holiday_layout_start_time);
        startTime.setOnClickListener(this);

        endDate = (TextView) findViewById(R.id.add_holiday_layout_end_date);
        endDate.setOnClickListener(this);
        endTime = (TextView) findViewById(R.id.add_holiday_layout_end_time);
        endTime.setOnClickListener(this);

        contentText = (TextView) findViewById(R.id.add_holiday_layout_task);
    ...
    private void addDataToSql(String checkerName, String start, String end, String content) {
        ...
        sqlDataBase.execSQL("insert into checkwork (check_creater,check_createtime,check_checker,check_checktime,leave_starttime,leave_endtime,leave_reason,check_state,company_id) values (?,?,?,?,?,?,?,?,?);",
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.add_holiday_layout_start_date:
                showDatePickerDialog(0);
                break;
            case R.id.add_holiday_layout_end_date:
                showDatePickerDialog(1);
                break;
            case R.id.add_holiday_layout_start_time:
                showTimePickerDialog(0);
                break;
            case R.id.add_holiday_layout_end_time:
