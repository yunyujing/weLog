...
import com.zzia.graduation.adapters.CheckClaimFragmentAdapter;
 ...
 */
public class CheckClaimFragment extends Fragment{
    private RecyclerView recyclerView;
    private ArrayList<BaseBean> plans;
    private CheckClaimFragmentAdapter createPlanFragmentAdapter;
    ...
    private void initData() {
        plans=new ArrayList<>();
        plans = CheckWork.getCheckClaimList(getActivity());
    }
    ...
    private void initView(View view) {
        ...
        createPlanFragmentAdapter =new CheckClaimFragmentAdapter(getContext(),plans);
