...
import com.zzia.graduation.adapters.CheckHolidayFragmentAdapter;
 ...
 */
public class CheckHolidayFragment extends Fragment{
    private RecyclerView recyclerView;
    private ArrayList<BaseBean> plans;
    private CheckHolidayFragmentAdapter createPlanFragmentAdapter;
    ...
    private void initData() {
        plans=new ArrayList<>();
        plans = CheckWork.getCheckHolidayList(getActivity());
    }
    ...
    private void initView(View view) {
        ...
        createPlanFragmentAdapter =new CheckHolidayFragmentAdapter(getContext(),plans);
