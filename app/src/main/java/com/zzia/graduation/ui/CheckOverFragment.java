...
import com.zzia.graduation.adapters.CheckOverFragmentAdapter;
 ...
 */
public class CheckOverFragment extends Fragment{
    private RecyclerView recyclerView;
    private ArrayList<BaseBean> plans;
    private CheckOverFragmentAdapter createPlanFragmentAdapter;
    ...
    private void initData() {
        plans=new ArrayList<>();
        plans = CheckWork.getCheckOverTimeList(getActivity());
    }
    ...
    private void initView(View view) {
        ...
        createPlanFragmentAdapter =new CheckOverFragmentAdapter(getContext(),plans);
