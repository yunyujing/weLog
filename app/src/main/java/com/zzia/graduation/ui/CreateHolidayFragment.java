...
import com.zzia.graduation.adapters.CreateHolidayFragmentAdapter;
...
public class CreateHolidayFragment extends Fragment{
    ...
    private CreateHolidayFragmentAdapter createPlanFragmentAdapter;
    ...
    private void initData() {
        plans=new ArrayList<>();
        plans = CheckWork.getCreateHolidayList(getActivity());
    }
    ...
    private void initView(View view) {
        ...
        createPlanFragmentAdapter =new CreateHolidayFragmentAdapter(getContext(),plans);
