...
import com.zzia.graduation.adapters.CreateClaimFragmentAdapter;
...
public class CreateClaimFragment extends Fragment{
    ...
    private CreateClaimFragmentAdapter createPlanFragmentAdapter;
    ...
    private void initData() {
        plans=new ArrayList<>();
        plans = CheckWork.getCreateClaimList(getActivity());
    }
    ...
    private void initView(View view) {
        ...
        createPlanFragmentAdapter =new CreateClaimFragmentAdapter(getContext(),plans);
