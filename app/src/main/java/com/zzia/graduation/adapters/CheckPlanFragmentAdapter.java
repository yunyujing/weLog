 ...
 */
public class CheckPlanFragmentAdapter extends RecyclerView.Adapter{
    private Context context;
    private ArrayList<BaseBean> list;
    public CheckPlanFragmentAdapter(Context applicationContext, ArrayList<BaseBean> list) {
    ...
    class PlanListItemViewHOlder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            CheckPlanActivity.startCheckPlanActivity(context,list.get(position));
        }
    }
}
