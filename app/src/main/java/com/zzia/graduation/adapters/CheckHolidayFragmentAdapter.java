 ...
 */
public class CheckHolidayFragmentAdapter extends RecyclerView.Adapter{

    private Context context;
    private ArrayList<BaseBean> list;

    public CheckHolidayFragmentAdapter(Context applicationContext, ArrayList<BaseBean> list) {
    ...
    class PlanListItemViewHOlder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            CheckHolidayActivity.startCheckHolidayActivity(context, list.get(position));
        }
    }
}
