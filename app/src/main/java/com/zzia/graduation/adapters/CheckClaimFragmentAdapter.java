 ...
 */
public class CheckClaimFragmentAdapter extends RecyclerView.Adapter{

    private Context context;
    private ArrayList<BaseBean> list;
    public CheckClaimFragmentAdapter(Context context, ArrayList<BaseBean> plans) {
    ...
    class PlanListItemViewHOlder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            CheckClaimActivity.startCheckClaimActivity(context, list.get(position));
        }
    }
}
