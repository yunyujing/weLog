 ...
 */
public class CreatePlanFragmentAdapter extends RecyclerView.Adapter {
    private Context context;
    private ArrayList<BaseBean> list;

    public CreatePlanFragmentAdapter(Context applicationContext, ArrayList<BaseBean> list) {
