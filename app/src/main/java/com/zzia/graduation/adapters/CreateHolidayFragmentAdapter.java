 ...
 */
public class CreateHolidayFragmentAdapter extends RecyclerView.Adapter{
    private Context context;
    private ArrayList<BaseBean> list;

    public CreateHolidayFragmentAdapter(Context applicationContext, ArrayList<BaseBean> list) {
