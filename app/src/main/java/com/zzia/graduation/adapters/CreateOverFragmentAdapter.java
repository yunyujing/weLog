 ...
 */
public class CreateOverFragmentAdapter extends RecyclerView.Adapter{
    private Context context;
    private ArrayList<BaseBean> list;

    public CreateOverFragmentAdapter(Context applicationContext, ArrayList<BaseBean> list) {
