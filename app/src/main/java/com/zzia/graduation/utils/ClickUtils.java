...
public class ClickUtils {
    ...
    public static void doubleClickExit(final Activity activity, CharSequence text) {
        doubleClick(activity, text, new View.OnClickListener() {
            @Override
     ...
     */
    public static void doubleClick(Context context, CharSequence text, View.OnClickListener onClickListener) {
